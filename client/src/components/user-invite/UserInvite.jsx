...
class UserInvite extends React.Component {
  ...
  render() {
    return (
      <>
        <button className={`${buttonStyles.button} btn-reset-style`} id="user-invite-btn" onClick={this.toggleModal}>
          <FontAwesomeIcon icon={faUserPlus} size="lg" />
        </button>
        <HoverTooltip text={'Invite someone to this channel.'} targetId="user-invite-btn" />
