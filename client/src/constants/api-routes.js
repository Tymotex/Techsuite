...
export const BASE_URL = "http://128.199.207.32:5000/api";  // Change back to "/api" on deployment. Change IP address between localhost and 128.199.207.32 on dev/deployment
