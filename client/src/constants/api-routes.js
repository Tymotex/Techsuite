...
export const BASE_URL = "http://localhost:5000/api";  // Change back to "/api" on deployment. Change IP address between http://localhost:5000/api and https://techsuite.dev/api on dev/deployment
