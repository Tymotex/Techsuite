...
5	\N	\N	https://techsuite.dev/api/images/default.jpg	\N	\N	\N	Techsuite user	\N
6	Lex	Fridman	https://techsuite.dev/api/images/user_6_profile_1.jpg	\N	I'm an AI researcher working on autonomous vehicles, human-robot interaction, and machine learning at MIT and beyond.	Massachusetts	Research Scientist	MIT
...
SELECT pg_catalog.setval('public.bios_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.techsuite_users_id_seq', 8, true);
